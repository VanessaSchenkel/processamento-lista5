...
void SceneManager::initializeGraphics()
{
	...
	addShader("../shaders/FiltroCachorro.vs", "../shaders/FiltroCachorro.frag");
...
void SceneManager::mouse_callback(GLFWwindow * window)
{
...
void SceneManager::setupScene()
{
	...
	objects.push_back(obj); //adiciona o 
	...
	textureMaskVignette = loadTexture("../textures/Vignette.png");
	textureMaskCachorro = loadTexture("../textures/cachorro.png");
...
void SceneManager::setupCamera2D() //TO DO: parametrizar aqui
{
	...
	shaders[0]->Use();
	GLint projLoc = glGetUniformLocation(shaders[0]->Program, "projection");
	glUniformMatrix4fv(projLoc, 1, GL_FALSE, glm::value_ptr(projection));

	shaders[1]->Use();
	GLint projLoc = glGetUniformLocation(shaders[1]->Program, "projection");
	glUniformMatrix4fv(projLoc, 1, GL_FALSE, glm::value_ptr(projection));

	shaders[2]->Use();
	GLint projLoc = glGetUniformLocation(shaders[2]->Program, "projection");
	glUniformMatrix4fv(projLoc, 1, GL_FALSE, glm::value_ptr(projection));

	shaders[3]->Use();
	GLint projLoc = glGetUniformLocation(shaders[3]->Program, "projection");
	glUniformMatrix4fv(projLoc, 1, GL_FALSE, glm::value_ptr(projection));

	shaders[4]->Use();
	GLint projLoc = glGetUniformLocation(shaders[4]->Program, "projection");
	glUniformMatrix4fv(projLoc, 1, GL_FALSE, glm::value_ptr(projection));

	shaders[5]->Use();
	GLint projLoc = glGetUniformLocation(shaders[5]->Program, "projection");
	glUniformMatrix4fv(projLoc, 1, GL_FALSE, glm::value_ptr(projection));

	shaders[6]->Use();
	GLint projLoc = glGetUniformLocation(shaders[6]->Program, "projection");
	glUniformMatrix4fv(projLoc, 1, GL_FALSE, glm::value_ptr(projection));
}
